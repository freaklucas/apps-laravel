                ...
                <div class="col-md-6 offset-md-3">
                    <div class="card">
                        <div class="card-header">
                            <h4><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-book-half" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{route('post.create')}}">
                                ...
                                <button type="submit" class="btn btn-outline-info">Submeter</button>
                            </form>
                        </div>
                </div>
            </div>
